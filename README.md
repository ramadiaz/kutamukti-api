...
<div align="center">
  ...
  <p align="center">
    ...
    <br />
    <a href="https://github.com/ramadiaz/kutamukti-api"><strong>Explore the docs »</strong></a>
    <br />
    <br />
...
1. **Clone the repository**:
   ...
   ```bash
   git clone https://github.com/ramadiaz/kutamukti-api.git
   cd kutamukti-api
   ```
...
Project Link: [https://github.com/ramadiaz/kutamukti-api](https://github.com/ramadiaz/kutamukti-api)
